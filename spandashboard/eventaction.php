         ...
         if(isset($_POST['submit'])){
              ...
              //  print_r($title);
                ...
                $fileextstored = array('png','jpg','jpeg');
                        ...
                        $destinationfile = '../uploads/gallery/'.$filename; //yedi condition satisfy vayo vani upload vanni folder ma gayera $filename save hunxa 
                        move_uploaded_file($filetmp,$destinationfile);
                                // -------------------------------------------------------------
                        $sql ="INSERT INTO gallery(title,description,image,date,time,venue,organizer) VALUES ('$title','$description','$destinationfile','$date','$time','$venue','$organizer')";
