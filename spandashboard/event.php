...
<body id="page-top">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
        <div class="sidebar-brand-icon ">
          ...
          <img style="height:auto; width:100%; margin-left:40%; margin-top:5%;" src="../image/logo_span.png" alt="">
        </div>
        <div class="sidebar-brand-text mx-3">hotel span</div>
      </a>
  ...
  <div class="container clearfix bg-secondary text-white text-center">
    <div class="col-lg-12"> <span class="alignleft small "> &copy;2020, Hotel span. All Rights Reserved.</span> <span class="alignright small">Made with <i class="fa fa-heart"></i> by <a  class="text-white"  href="http://ansunepal.com/" >Ansu Tech</a>. </span> </div>
  </div>
</footer>
      <!-- End of Footer -->
    </div>
