        ...
        <section class="gallery_area section_gap">
            <div class="container">
                ...
                <div class="row " id="">
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="image/gallery/three.jpg" alt="">
                            <div class="hover">
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="image/gallery/04t.jpg" alt="">
                            <div class="hover">
                            	<a class="light" href="image/gallery/04t.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="image/gallery/one.jpg" alt="">
                            <div class="hover">
                            	<a class="light" href="image/gallery/one.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="image/gallery/three.jpg" alt="">
                            <div class="hover">
                            	<a class="light" href="image/gallery/three.jpg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div> -->
